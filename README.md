...
通过[媒体(点我直达)](https://mp.weixin.qq.com/s?src=11&timestamp=1626865270&ver=3204&signature=bInxUb6QX**vx0U2L9B0ExS*ces1aDRCWMGAE-7zgYyuNV3CZ2dboRfqDC0-b4Sgtu5umGWRCzs5U5OLCPvZXf7UJNfNtgZ*XR5foaQMLvB-kFxwHkUeQSu71hb1oHyc&new=1)(如下图所示)了解到, 长安链以区块链专用加速芯片为核心提供超高的区块链数据处理性能。与纯软件平台相比，区块链专用加速板卡的数字加密、解密处理速度提升20倍，转账、支付交易速度则提升了50倍。
# TPS验证
...
# 验证结论
## 2021.07.21 
以上结论，在没有长安链专用硬件加速的情况下的测试的出的TPS均值在3300TPS。该结论大于理论上无硬件减速的长安链2000TPS。
ps: 该结论可能具有片面性，望指正。
