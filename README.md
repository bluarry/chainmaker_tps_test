...
通过[媒体(https://xw.qq.com/partner/sxs/20210610002484/TEC2021061000248400?ADTAG=sxs&pgv_ref=sxs)](https://xw.qq.com/partner/sxs/20210610002484/TEC2021061000248400?ADTAG=sxs&pgv_ref=sxs)(如下图所示)了解到, 长安链以区块链专用加速芯片为核心提供超高的区块链数据处理性能。与纯软件平台相比，区块链专用加速板卡的数字加密、解密处理速度提升20倍，转账、支付交易速度则提升了50倍。
# TPS验证
